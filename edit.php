...
<body>
    <div class="container">
         <?php
            include 'koneksi.php';
            $npsn   = $_GET ['npsn'];
            $query  = "SELECT * FROM tbl_data WHERE npsn = '$npsn'";
        ...
        <div class="col-md-8 m-auto card p-5 shadow p-3 mb-5 bg-body rounded">
            <form action="editproses.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="sk_izin_oprasional" type="text" class="form-control" id="exampleFormControlInput1" value="<?= $data['sk_izin_oprasional']?>">
                </div>
                <div class="mb-3">
                    <input type="hidden" name="npsn" value="<?= $npsn?>">
                    <label for="exampleFormControlInput1" class="form-label">Tanggal Izin Oprasional</label>
                    <input name="tgl_izin_oprasional" type="text" class="form-control" id="exampleFormControlInput1" value="<?= $data['tgl_izin_oprasional']?>">
                </div>
                <div class="mb-3">
                    <input type="hidden" name="npsn" value="<?= $npsn?>">
